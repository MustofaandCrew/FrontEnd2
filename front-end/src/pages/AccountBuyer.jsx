            ...
            <div className="row mb-5 navbar-dekstop">
                ...
                <div className="form-account">
                    <form className="row g-3">
                        ...
                        <div className="col-md-6 mt-4">
                            <label for="inputEmail" className="form-label">Your Email</label>
                        ...
                        <div className="col-md-4 mt-4">
                            <label for="inputProvince" className="form-label">Province</label>
                        ...
                        <div className="col-md-4 mt-4">
                            <label for="inputPostalCode" className="form-label">Postal Code</label>
                        ...
                        <div className="col-12 mt-5">
                            <button type="submit" className="btn btn-success btn-save">Save Now</button>
                        </div>
                    </form>
                </div>
            </div>
